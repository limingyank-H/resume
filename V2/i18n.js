...
const translations = {
    zh: {
        ...
        'hero.pitch': '11 年产品经验，从 <em>UBER 增长</em>到<em>阿里 SaaS</em>，现负责<em>创量广告平台</em>',
        'hero.pitchdesc': '专注把 AI 变成能落地、能被客户用起来的产品。擅长从用户行为到商业闭环的完整设计。',
        'hero.contact': '联系我',
        'hero.download': '下载简历',
        'hero.scroll': '向下滚动',
        'hsm.copyright': '软著',
    ...
    en: {
        ...
        'hero.pitch': '11 yrs in product — from <em>UBER growth</em> to <em>Alibaba SaaS</em>, now leading <em>Chuangliang Ad Platform</em>',
        'hero.pitchdesc': 'Turning AI into products that actually ship and get used. Strong at end-to-end design from user behavior to business loop.',
        'hsm.copyright': 'Copyrights',
        'hsm.seed': 'Seed Users',
